     ...
     (select avg(ss_list_price) as B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between [LISTPRICE.2] and [LISTPRICE.2]+10
          ...
          or ss_wholesale_cost between [WHOLESALECOST.2] and [WHOLESALECOST.2]+20)) as B2,
     (select avg(ss_list_price) as B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between [LISTPRICE.3] and [LISTPRICE.3]+10
          ...
          or ss_wholesale_cost between [WHOLESALECOST.3] and [WHOLESALECOST.3]+20)) as B3,
     (select avg(ss_list_price) as B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between [LISTPRICE.4] and [LISTPRICE.4]+10
          ...
          or ss_wholesale_cost between [WHOLESALECOST.4] and [WHOLESALECOST.4]+20)) as B4,
     (select avg(ss_list_price) as B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between [LISTPRICE.5] and [LISTPRICE.5]+10
          ...
          or ss_wholesale_cost between [WHOLESALECOST.5] and [WHOLESALECOST.5]+20)) as B5,
     (select avg(ss_list_price) as B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between [LISTPRICE.6] and [LISTPRICE.6]+10
          ...
          or ss_wholesale_cost between [WHOLESALECOST.6] and [WHOLESALECOST.6]+20)) as B6
[_LIMITC];
